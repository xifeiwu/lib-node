...
async function startSocksServer(socksServerConfig: SocksServerConfig<any>) {
...
export async function startSocksServerV5(config?: Partial<SocksServerConfig<'v5'>>) {
  const socksServerConfig: SocksServerConfig<'v5'> = {
    socksVersion: 'v5',
    methodList: [{method: EMethod.NoAuth}],
    ...(config ?? {}),
  };
  return startSocksServer(socksServerConfig);
}
...
export async function startSocksServerVc1(config?: Partial<SocksServerConfig<'vc1'>>) {
